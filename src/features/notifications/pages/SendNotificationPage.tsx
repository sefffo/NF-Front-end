...
export const SendNotificationPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // ── Other channels (SMS / PUSH / WEBHOOK) → existing mock ─────────────────
    try {
  ...
  const fieldError = (field: string): string | undefined => {
    ...
    const msgs =
      ui.errors[field] ??
      ui.errors[field.toLowerCase()] ??
      ui.errors[field.toUpperCase()];
    return msgs?.join(', ');
  };
        ...
        <form onSubmit={handleSubmit} className="form-stack">
          ...
          <div className="input-group">
            ...
            <Input
              ...
              placeholder={
                channel === 'EMAIL' ? 'user@example.com, other@example.com' : '+15552345678'
              }
              required
          ...
          {channel === 'EMAIL' && (
            <div className="input-group">
              <Input
                ...
                required
                className={
                  fieldError('Subject') || fieldError('subject') ? 'input-error' : ''
                }
              />
